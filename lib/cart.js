...
module.exports = function (restClient) {
  ...
  module.update = (customerToken, cartId, cartItem, campaignToken = undefined) => {
  ...
  module.totals = (customerToken, cartId, campaignToken = undefined) => {
  ...
  module.shippingInformation = (customerToken, cartId, body, campaignToken = undefined) => {
    url += `totals?token=${customerToken}&cartId=${cartId}`;
    if (campaignToken) {
      url += `&campaignToken=${campaignToken}`;
    }
